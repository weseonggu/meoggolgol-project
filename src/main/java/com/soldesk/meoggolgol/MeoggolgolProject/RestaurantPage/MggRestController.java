...
public class MggRestController {
	...
	public String goRestPage(@RequestParam double lo, @RequestParam double la, @RequestParam String imgUrl, @RequestParam String placeUrl, @RequestParam String placeName, @RequestParam String roadAddress, ReviewRequest reviewrequest) {
		mrs.info(placeUrl);
