...
function toggleCategoryButtonVisibility(categoryValues) {
	...
	// 기타 카테고리 버튼
	var excludedCategories = ['한식', '중식', '양식', '일식'];
	var hasOtherCategory = categoryValues.some(function(category) {
